...
public class AssinaturaConstants {

    public static final BigDecimal ASSINATURA_TRIMESTRAL = new BigDecimal("50.00");

    public static final BigDecimal ASSINATURA_SEMESTRAL = new BigDecimal("200.00");

    public static final BigDecimal ASSINATURA_ANUAL = new BigDecimal("350.00");
